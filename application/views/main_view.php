...
<div class="page-header">
			...
			<div class="top-menu">
				<ul class="nav navbar-nav pull-right">
					...
					<li class="dropdown dropdown-extended quick-sidebar-toggler">
						...
						<i class="icon-question" style = "color:blue;"></i>
					</li>
					<li class="dropdown dropdown-extended quick-sidebar-toggler">
						<span class="sr-only">Toggle Quick Sidebar</span>
	...
	<div class="page-header-menu">
		<div class="container-fluid" style = "background-color:rgb(7,116,152)">
			<!-- BEGIN MEGA MENU -->
			...
			<div class="hor-menu ">
				<ul class="nav navbar-nav">
					<li>
						<a href="index.html"><i class="fa fa-home" style = "font-size:20px;"></i></a>
					</li>
					<li class="menu-dropdown mega-menu-dropdown" >
						<a data-hover="megamenu-dropdown" data-close-others="true" data-toggle="dropdown" href="javascript:;" class="dropdown-toggle">
						 <i class="fa fa-bolt" style = "font-size:20px;"></i> Площадки  <i class="fa fa-circle" style = "color:#3CB371"></i>
						</a>
					...
					<li class="menu-dropdown mega-menu-dropdown mega-menu-full ">
						<a data-hover="megamenu-dropdown" data-close-others="true" data-toggle="dropdown" href="javascript:;" class="dropdown-toggle">
						<i class="fa fa-bolt" style = "font-size:20px;"></i> Пункты  <i class="fa fa-circle" style = "color:#3CB371"></i>
						</a>
					...
					<li class="menu-dropdown classic-menu-dropdown ">
						...
						<i class="fa fa-bolt" style = "font-size:20px;"></i>Объекты  <i class="fa fa-circle" style = "color:#3CB371"></i>
						</a>
					...
					<li class="menu-dropdown mega-menu-dropdown mega-menu-full ">
						<a data-hover="megamenu-dropdown" data-close-others="true" data-toggle="dropdown" href="javascript:;" class="dropdown-toggle">
						  <i class="fa fa-bolt" style = "font-size:20px;"></i>Компания  <i class="fa fa-circle" style = "color:#3CB371"></i>
						</a>
						<ul class="dropdown-menu">
							<li>
								<div class="mega-menu-content">
					...
					<li class="menu-dropdown">
						<a href="angularjs" target="_blank" class="tooltips" data-container="body" data-placement="bottom" data-html="true" data-original-title="AngularJS version demo"><i class="fa fa-user" style = "font-size:20px;"></i>  Сотрудники  <i class="fa fa-circle" style = "color:#3CB371"></i></a>
					</li>
					<li class="menu-dropdown mega-menu-dropdown mega-menu ">
						<a data-hover="megamenu-dropdown" data-close-others="true" data-toggle="dropdown" href="javascript:;" class="dropdown-toggle">
						  <i class="fa fa-bolt" style = "font-size:20px;"></i> Базы <i class="fa fa-circle" style = "color:#3CB371"></i>
						</a>
						<ul class="dropdown-menu">
							<li>
								<div class="mega-menu-content">
					...
					<li class="menu-dropdown mega-menu-dropdown mega-menu ">
						<a data-hover="megamenu-dropdown" data-close-others="true" data-toggle="dropdown" href="javascript:;" class="dropdown-toggle">
						  <i class="fa fa-bolt" style = "font-size:20px;"></i> Транспорт <i class="fa fa-circle" style = "color:#3CB371"></i>
						</a>
						<ul class="dropdown-menu">
							<li>
								<div class="mega-menu-content">
					...
					<li class="menu-dropdown mega-menu-dropdown mega-menu ">
						<a data-hover="megamenu-dropdown" data-close-others="true" data-toggle="dropdown" href="javascript:;" class="dropdown-toggle">
						  <i class="fa fa-bolt" style = "font-size:20px;"></i> Мусоропроводы   <i class="fa fa-circle" style = "color:#3CB371"></i>
						</a>
						<ul class="dropdown-menu">
							<li>
								<div class="mega-menu-content">
